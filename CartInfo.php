...
if($infonum>0){
    $sql = "SELECT ProductName,ProductCost,ProductDesc,ProductImage FROM CSIS2440.Products WHERE idProducts= ".$infonum;
    ...
    if(mysqli_num_rows($result)>0) {
        ...
        echo "<td align='left'><img src='$infoimage' height='160' width='100'></td>";
        echo "</tr>";
    }
    echo "</table>";
}
